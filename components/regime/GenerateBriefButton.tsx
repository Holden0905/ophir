  ...
  return (
    <div className="card p-5">
      ...
      <button
        ...
        className={`mt-3 inline-flex w-full items-center justify-center gap-2 rounded bg-[var(--accent-amber)] px-3 py-2 font-ui text-sm font-medium text-black transition-shadow hover:opacity-90 active:scale-[0.98] ${
          pending
